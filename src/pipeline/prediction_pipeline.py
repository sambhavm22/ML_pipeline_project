...
#define a function for loading object
#create custom class based upon our dataset
#create a function to convert data into Data frame with the help of dictionary 
...
class PredictionPipeline:
    ...
    def predict(self, features):
        ...
        preprocessor_path = os.path.join("artifacts/data_transformation", "preprocess.pkl")
